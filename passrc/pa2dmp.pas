$WIDTH=100
$LENGTH=55
$TITLE PA2DMP.PAS, last modified 11/28/83, zw
MODULE pa2dmp OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- pass 2 dump routines*)
  ...
  while v <> nil do
	...
	with symbol^.block^ do
	  case kind of
	    ...
	    program_blk,
	    module_blk,
	    data_blk: fio_line (dumpfb, 'IN '  || id^.text);
