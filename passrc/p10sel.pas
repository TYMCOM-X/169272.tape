$WIDTH=100
$LENGTH=55
$TITLE P10SEL.PAS, last modified 1/18/84, zw
MODULE p10sel OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- PDP10 high-level to low-level IF conversion*)
    ...
    with node^ do begin
      case opcode of
        ...
        (* In the case of a direct data reference, use the natural size for the
           ...
           registerhich it will be loaded. *)
 ...
 begin
  with t^ do begin
    case opcode of
      ...
      array_ref:
        begin
          base_array := transform (base_array);
