$WIDTH=100
$LENGTH=55
$TITLE VAXCMP.PAS, last modified 1/18/84, zw
MODULE vaxcmp OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- VAX comparision and jump code generation*)
...
begin
  if compare_with_zero (op1, cmp, tcmp) then
    ...
    if aconstp ( loc1, value1 ) and aconstp ( loc2, value2 ) thenn
