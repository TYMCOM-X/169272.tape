$WIDTH=100
$LENGTH=55
$TITLE PASJMP.PAS, last modified 1/3/84, zw
MODULE pasjmp OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- Flow Analysis Module*)
...
(*  EXPLODE BOOLEANS scans the intermediate form and explodes boolean operators
    ...
    operators in that they do not constitute a use of their operands; theps
