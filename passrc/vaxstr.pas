$WIDTH=100
$LENGTH=55
$TITLE VAXSTR.PAS, last modified 10/21/83, zw
MODULE vaxstr OPTIONS SPECIAL(WORD);
(*VAXSTR - VAX code generator string related routines.*)
...
public procedure re_regs ( reg_set: set_of_registers );
