$WIDTH=100
$LENGTH=55
$TITLE VAXIMD.PAS, last modified 10/21/83, zw
MODULE vaximd OPTIONS SPECIAL(WORD);
(*initialization of machine-dependent declarations for VAX/VMS*)
...
(*initializes the type allocation tables used by PASTAL*)
...
EXTERNAL VAR alc_tables: env;

PROCEDURE init_alc_tables OPTIONS SPECIAL(COERCIONS);
(*initializes the storage allocation tables used by PASALC*)
...
begin
  ...
  stt_cons('SPECIAL_DISP_TWICE',	stat_special, 5);
