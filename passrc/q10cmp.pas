$WIDTH=100
$LENGTH=55
$TITLE Q10CMP.PAS, last modified 12/8/83, zw
MODULE q10cmp OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- PDP10 quick comparision and jump code generation*)
