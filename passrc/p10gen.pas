$WIDTH=100
$LENGTH=55
$TITLE P10GEN.PAS, last modified 1/18/84, zw
MODULE p10gen OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- PDP10 code generator*)
  ...
  with tpl^ do begin
	...
	if agg_width > 0 then begin
	  ...
	  do_movem (maddr, r, agg_width, left_aligned)
        ...
        (*  The assignment has the form DESC (lhs, len) := DESC (rhs,len).
