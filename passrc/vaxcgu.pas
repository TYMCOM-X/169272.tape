$WIDTH=100
$LENGTH=55
$TITLE VAXCGU.PAS, last modified 1/18/84, zw
MODULE vaxcgu OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- VAX code generator utilities*)
...
type rts_name_array = array [rt_first..rt_last_used] of string [publics_length];
public var
...
public function get_ext_or_stat (list: def_types; symbol: sym): def;
 var d: def;
 begin
  d := def_lists [list];
  while d <> nil do begin
...
public function relsym (s: sym): rel_syllable;
 begin
...
public function gen_cst ( value: int_type; vtype: vax_type ): addr_desc;
