$WIDTH=100
$LENGTH=55
$TITLE VAXSET.PAS, lst modified 1/18/84, zw
MODULE vaxset OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- VAX set expression evaluation*)
...
begin
  ...
  with gen_cst_set do begin
    ...
    arg[3] := int_value (len (byte_count, first_byte));
    in_temp := false
  end
end (* gen_cst_set *);
