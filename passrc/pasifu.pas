$WIDTH=100
$LENGTH=55
$TITLE PASIFU.PAS, last modified 1/13/84, zw
MODULE pasifu OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- IF manipulation utility*)
          ...
          read_op, write_op:
            begin
              ...
              if rw_precision <> nil then
                rw_precision^.usage_ := rw_precision^.usage_count + 1;
            end;
...
begin
  ...
  ch_last^.cursor := cursor (if_out_file);
end (* open_out_tuples *);
$PAGE open_in_tuples
