$WIDTH=100
$LENGTH=55
$TITLE P10CMP.PAS, last modified 1/18/84, zw
MODULE p10cmp OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- PDP10 comparision and jump code generation*)
...
procedure test_and_skip
  ...
  (* These routine contains four local procedures that generate various
     ...
     Aamine the global parameter "branching". *)
