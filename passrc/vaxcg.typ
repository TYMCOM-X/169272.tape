(*VAXCG.TYP, last modified 11/29/83, zw*)
...
TYPE
    ...
    (* The following defines the set of runtime symbols (runtime subroutines,
       ...
       expansion *)
    rt_symbol = ( rt_first, rt_main_frame, (* for addr of main's stack frame *)
    rt_uw_rtn, (**** stack unwind to specified frame ****)
    rt_uw_prg, (**** stack unwind to main program ****)
    rt_exp_ii, (* exponentiation *)
    rt_exp_ri, rt_exp_di, rt_exp_rr, rt_exp_dd, rt_r_rnd2, rt_d_rnd2, rt_r_sqrt,
      rt_d_sqrt, (* math functions *)
      rt_r_ln, rt_d_ln, rt_r_log, rt_d_log, rt_r_exp, rt_d_exp, rt_r_sin,
	rt_d_sin, rt_r_asin, rt_d_asin, rt_r_sinh, rt_d_sinh, rt_r_cos, rt_d_cos
	  , rt_r_acos, rt_d_acos, rt_r_cosh, rt_d_cosh, rt_r_tan, rt_d_tan,
	    rt_r_tanh, rt_d_tanh, rt_r_ctan, rt_d_ctan, rt_r_atan, rt_d_atan,
	      rt_r_atn2, rt_d_atn2, rt_rand_set, (* one and zero operand forms *)
	      rt_rand, rt_new, (* allocation routines *)
	      rt_dispose, rt_extent, rt_sub_chk, (* error check reporting *)
	      rt_str_chk, rt_ovl_chk, rt_val_chk, rt_ptr_chk, rt_fil_chk,
		rt_fld_chk, rt_cmp_chk, rt_ass_chk, rt_case_chk,
		(* Only required search and verify runtime routines are for
		   upper/no casing for strings on
		   l and o format sets. *)
		rt_sr_fl, rt_sru_fl, rt_sr_fo, rt_sru_fo, rt_vf_fl, rt_vfu_fl,
		  rt_vf_fo, rt_vfu_fo, rt_genset, rt_stmt, (* for debugger *)
		  rt_open, rt_rewrite, rt_reset, (****  input / output  ****)
		  rt_open_typed, rt_open_binary, rt_get, rt_get_char, rt_put,
		    rt_put_char, rt_read_binary, rt_write_binary, rt_read_image,
		      rt_write_image, rt_close, rt_scratch, rt_close_all,
			rt_file_size, rt_break, rt_empty_text, rt_page, rt_clear
			  , rt_iostatus, rt_iostat_last, rt_extstatus, rt_read,
			    rt_write, rt_getstring, rt_put_fixed_string,
			      rt_put_varying_string, rt_put_last_string,
				rt_readln, rt_writeln, rt_seek, rt_stop,
				  rt_upper_table, (* uppercase conversion table xfer vector *)
				  rt_lower_table, (* lowercase conversion table xfer vector *)
				  rt_set_handler, rt_rst_handler, rt_mask,
				    rt_unmask, rt_masked, rt_pending, rt_signal,
				      rt_resignal, rt_stat_math, rt_stat_program
					, rt_stat_special, rt_stat_exio,
					  rt_exmessage, rt_exc_vaxcond, rt_date,
					    rt_time, rt_fname, rt_runtime, (* CPU time in millisecs *)
    ...
    def_types = ( sym_def, (* user declared symbol *)
    ...
    ( vax_byte, vax_word, vax_long, vax_quad, vax_float, vax_double );
    addressing_mode = ( auto_inc, (* auto_increment *)
    ...
    code_types = (instruction, bytelen, wordlen, fullword, setbyte, stringword,
      displacement, quadword, pstringword, defmark, origin, source, comment,
	deftemp, nullcode, maskword, realword, doubleword , indirect_word );
    ...
    str_translation = ( no_trans, (* no case translation *)
    upper_trans, (* translate to uppercase *)
    lower_trans ); (* translate to lowercase *)
    (* Data accessing information *)
    data_alignment = ( unsigned_value, (* right justified, zero extended *)
...
CONST
    ...
    reg_addr_desc: addr_desc := (vax_long, other, false, false, noreg, noreg, 0,
      (register_sc));
    null_location: addr_desc := (vax_long, other, false, false, noreg, noreg, 0,
      (unallocated));
    immediate_reference: addr_desc := (vax_long, other, true, false, noreg,
      noreg, 0, (absolute_sc));
    absolute_reference: addr_desc := (vax_long, other, false, false, noreg,
      noreg, 0, (absolute_sc));
    temp_reference: addr_desc := (vax_long, other, false, false, noreg, fp, 0, (
      temp_sc));
    parm_reference: addr_desc := (vax_long, other, false, false, noreg, ap, 0, (
      parameter_sc, nil));
    push_reference: addr_desc := (vax_long, auto_dec, false, false, noreg, sp, 0
      , (absolute_sc));
    pop_reference: addr_desc := (vax_long, auto_inc, false, false, noreg, sp, 0,
      (absolute_sc));
    stack_reference: addr_desc := (vax_long, other, false, false, noreg, sp, 0,
      (absolute_sc));
    stack_top_reference: addr_desc := (vax_long, other, false, false, noreg, sp,
      0, (absolute_sc));
    fill_addr: addr_desc := (vax_byte, other, true, false, noreg, noreg, 32, (
      absolute_sc) );
    no_preference: addr_desc := (vax_long, other, false, false, noreg, noreg, 0,
      (unallocated) );
      (* immediate address for fill character ( ' ' )  *)
      (* Address descriptors for the more commonly used registers. *)
    r0_addr: addr_desc := (vax_long, other, false, false, noreg, r0, 0, (
      register_sc));
    r1_addr: addr_desc := (vax_long, other, false, false, noreg, r1, 0, (
      register_sc));
    r2_addr: addr_desc := (vax_long, other, false, false, noreg, r2, 0, (
      register_sc));
    r3_addr: addr_desc := (vax_long, other, false, false, noreg, r3, 0, (
      register_sc));
    r4_addr: addr_desc := (vax_long, other, false, false, noreg, r4, 0, (
      register_sc));
    r5_addr: addr_desc := (vax_long, other, false, false, noreg, r5, 0, (
      register_sc));
    ap_addr: addr_desc := (vax_long, other, false, false, noreg, ap, 0, (
      register_sc));
    fp_addr: addr_desc := (vax_long, other, false, false, noreg, fp, 0, (
      register_sc));
    sp_addr: addr_desc := (vax_long, other, false, false, noreg, sp, 0, (
      register_sc));
$PAGE assert
