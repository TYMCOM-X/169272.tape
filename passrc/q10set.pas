$WIDTH=100
$LENGTH=55
$TITLE Q10SET.PAS, last modified 1/18/84, zw
MODULE q10set OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- PDP10 quick set expression evaluation*)
...
(* INTERNAL SET FREE intercepts frees of temporaries that could be reused.  For example,
   ...
   "freed" one e reused.  This game is only played within routines that are only
