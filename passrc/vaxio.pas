$WIDTH=100
$LENGTH=55
$TITLE VAXIO.PAS, last modified 1/18/84, zw
MODULE vaxio OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- VAX input/output routines*)
...
begin
  with node^ do begin
	...
	with rw_item^.desc.base^ do begin
	    ...
	    check_input := (rminval <> type_real^.rl) or
...
begin
  ...
  (* push the address of the file parameter. Dynamic temps used within
