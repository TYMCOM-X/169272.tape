$WIDTH=100
$LENGTH=55
$TITLE P10CLL.PAS, last modified 1/18/84, zw
MODULE p10cll OPTIONS SPECIAL(WORD);
(*TYM-Pascal compiler -- PDP10 subroutine call utilities*)
 ...
 begin
  with node^ do begin
    ...
    (* For a call to an external fortran routine, a parameter list of the following
       ...
       and such values are placed in the parameter list as parm n addr's.  Valu      of other data types are assumed to be value parameters, and an address is
