$TITLE PASTAL -- Type Allocation Module
...
begin
  hp_get (ord (address (tal_tbl_start)), ord (address (tal_tbl_end)), tal_tables);
end;
...
var
  elems_per_ef: int_type;                     (* number of elemper extraction field *)
