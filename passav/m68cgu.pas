...
const
    ...
    d_op     : op_check_record = ( [dreg_mode], reg_sizes, s_u    dls_op   : op_check_record = ( [dreg_mode], long_only, sgn );
...
begin
  with instr do begin
	...
	if (mode = displacement_mode) and (kind = absolute_sc) and (offset = 0) then
	  mode := indirect_mode;
      end;
    end;
