...
;  Direct JUMP and CALL instructions, stack adjusting return instructions
	...
	.BYTE	^O232
	.BYTE	LABEL&^O377
	.BYTE	LABEL&^O177400/^O400
	.BYTE	SEGADR&^O377
	.BYTE	SEGADR&^O177400/^O400
	$=.
	.ENDM
